  ...
  return (
    <div className="bg-white h-screen flex flex-col px-5 w-[65vh]">
      ...
      <div className="bg-white p-2 rounded-lg">
        ...
        <h2 className="text-center text-lg font-semibold text-gray-800 mb-4">Nhập Security Code</h2>
        <p className="text-center text-sm text-gray-600 mb-6">
          Vui lòng nhập security code hiện tại của bạn.
        </p>
...
export default EnterOldSecurityCode;
